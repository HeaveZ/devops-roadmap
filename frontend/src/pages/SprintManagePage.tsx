      ...
      <div className="bg-navy-800 border border-border rounded-xl p-5">
        ...
        <div className="flex flex-wrap gap-3">
          <input
            ...
            className="flex-1 min-w-[200px] px-3 py-2 bg-navy-900 border border-border rounded-lg text-sm text-ink placeholder:text-muted/70 focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/30"
          />
          <input
            type="date"
            value={startDate}
